...
public class DefaultUnmarshalContext implements UnmarshalContext {
	...
	public DefaultUnmarshalContext(UnmarshalSource src,
			DefaultUnmarshaller unmarshaller, RecordMapping recordMapping,
			Object record) {
		this.src = src;
	...
	public DefaultUnmarshalContext(DefaultUnmarshalContext parent,
			RecordMapping recordMapping, Object record) {
		this.src = parent.src;
	...
	public UnmarshalContext createMemberContext(Object member,
			RecordMapping memberMapping) {
	...
	public String getString(int size) throws MappingException {
		try {
			return new String(getBytes(size), getRecordAttributes(
					BaseRecordAttributes.class).getEncoding());
