...
public class DefaultMarshaller extends DefaultAbstractShaller
		implements
			Marshaller {
	...
	public void marshal(Object record, OutputStream os) throws MappingException {
		...
		if (null == rm)
			throw new MappingException("Don't know how to deal with "
					+ record.getClass());

		DefaultMarshalContext mc = new DefaultMarshalContext(null, this, rm,
				record, os);
